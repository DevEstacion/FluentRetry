...
public static class RetryPresets
{
    ...
    public static RetryBuilder Fast(this RetryBuilder builder) =>
        builder.Attempts(2).Delay(50).WithJitter(25);
    ...
    public static RetryBuilder Standard(this RetryBuilder builder) =>
        builder.Attempts(3).Delay(150).WithJitter(50);
    ...
    public static RetryBuilder Resilient(this RetryBuilder builder) =>
        builder.Attempts(5).Delay(500).WithJitter(200);
    ...
    public static RetryBuilder Network(this RetryBuilder builder) =>
        builder.Attempts(4).Delay(100).WithExponentialBackoff().WithJitter(50);

    /// <summary>
    /// Database operations - longer delays for database timeouts (3 attempts, 1000ms delay, 200ms jitter)
    /// </summary>
    public static RetryBuilder Database(this RetryBuilder builder) =>
        builder.Attempts(3).Delay(1000).WithJitter(200);
